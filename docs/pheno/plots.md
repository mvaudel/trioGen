...
| BMI at 6 m | z_bmi3 | `z_bmi3 ~ pregnancy_duration` per child sex | `LOGNO` | `centiles.pred` Z-scores | 9484 |
| BMI at 8 m | z_bmi4 | `z_bmi4 ~ pregnancy_duration` per child sex | `LOGNO` | `centiles.pred` Z-scores | 8451 |
| BMI at 1 y | z_bmi5 | `z_bmi5 ~ pregnancy_duration` per child sex | `LOGNO` | `centiles.pred` Z-scores | 8446 |
| BMI at 1.5 y | z_bmi6 | `z_bmi6 ~ pregnancy_duration` per child sex | `LOGNO` | `centiles.pred` Z-scores | 8286 |
| BMI at 2 y | z_bmi7 | `z_bmi7 ~ pregnancy_duration` per child sex | `LOGNO` | `centiles.pred` Z-scores | 6458 |
| BMI at 3 y | z_bmi8 | `z_bmi8 ~ pregnancy_duration` per child sex | `LOGNO` | `centiles.pred` Z-scores | 6573 |
| BMI at 5 y | z_bmi9 | `z_bmi9 ~ pregnancy_duration` per child sex | `LOGNO` | `centiles.pred` Z-scores | 5348 |
