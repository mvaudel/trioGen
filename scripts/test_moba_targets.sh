...
do
    ...
    java -Xmx64G -cp bin/triogen-0.4.0-beta/triogen-0.4.0-beta.jar no.uib.triogen.cmd.association.LinearModel -g $vcfFolder/$chr.vcf.gz -gf 1 -vi resources/targets_chr$chr -maf 0.05 -f $trioFile -p $phenoFile -pn $phenoName -cv $covariates -o $outputFolder/$chr.lm_target.gz -nv 2 -d 1
