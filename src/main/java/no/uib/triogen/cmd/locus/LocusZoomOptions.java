...
public enum LocusZoomOptions {
    ...
    phenoName("pn", "phenoName", "The name of the phenotype to export the locus zoom data on. Example: pheno1.", true, true),
    variantId("vi", "variantId", "The id of the variant to export the locus zoom data on. Example: rs123.", true, true),
