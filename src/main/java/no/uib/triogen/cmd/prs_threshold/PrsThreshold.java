...
public class PrsThreshold {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            PrsThresholdOptions.createOptionsCLI(lOptions);
            CommandLineParser parser = new DefaultParser();
            CommandLine commandLine = parser.parse(lOptions, args);

            PrsThresholdOptionsBean bean = new PrsThresholdOptionsBean(commandLine);
    ...
    private static void run(
        ...
        try {
            ...
            PrsThresholder prsThresholder = new PrsThresholder(
                    bean.genotypesFile, 
                    bean.phenoFile, 
                    bean.phenoName, 
                    childToParentMap, 
    ...
    private static void printHelp() {
        ...
        try (PrintWriter lPrintWriter = new PrintWriter(System.out)) {
            ...
            lPrintWriter.print("               ****               " + LINE_SEPARATOR);
            lPrintWriter.print("            PrsThreshold          " + LINE_SEPARATOR);
            lPrintWriter.print("==================================" + LINE_SEPARATOR);
            lPrintWriter.print(LINE_SEPARATOR
                    + "The PrsThreshold command exports thresholds to be used for scoring." + LINE_SEPARATOR
                    + LINE_SEPARATOR
                    ...
                    + "----------------------" + LINE_SEPARATOR
                    + LINE_SEPARATOR);
            lPrintWriter.print(PrsThresholdOptions.getOptionsAsString());
            lPrintWriter.flush();
        }
    }
}
