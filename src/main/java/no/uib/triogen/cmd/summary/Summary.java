...
/**
 * Extracts summary from the vcf files on given variants and/or samples.
 *
 * @author Marc Vaudel
 */
public class Summary {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            SummaryOptions.createOptionsCLI(lOptions);
            CommandLineParser parser = new DefaultParser();
            CommandLine commandLine = parser.parse(lOptions, args);

            SummaryOptionsBean bean = new SummaryOptionsBean(commandLine);
    ...
    private static void printHelp() {
        ...
        try (PrintWriter lPrintWriter = new PrintWriter(System.out)) {
            ...
            lPrintWriter.print(lineSeparator
                    ...
                    + "----------------------" + lineSeparator
                    + lineSeparator);
            lPrintWriter.print(SummaryOptions.getOptionsAsString());
            lPrintWriter.flush();
        }
    }
}
