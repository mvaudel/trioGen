...
public enum VariantFileOptions {
    ...
    build("b", "build", "The build to use when querying Ensembl as a number 37: grch37, 38: grch38. Default: 37.", true, true),
    population("p", "population", "The reference population to use as available in Ensembl. See https://rest.ensembl.org/documentation/info/variation_populations for details. Default: 1000GENOMES:phase_3:GBR.", true, true),
    r2("r", "r2", "The minimal r2 to allow for a proxy. Default: 0.2.", true, true),
